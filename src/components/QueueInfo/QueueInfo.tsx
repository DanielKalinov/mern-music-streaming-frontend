	...
	return (
		<>
			...
			<div
				...
				} hidden fixed bottom-[105px] right-[15px] p-4 card h-[600px] max-w-sm w-full overflow-y-auto [transition:transform_300ms_ease-in-out,opacity_200ms_ease-in-out] lg:block`}>
