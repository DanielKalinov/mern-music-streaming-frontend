	...
	return (
		<>
			...
			<div
				...
				} fixed top-0 left-1/2 -translate-x-1/2 p-4 h-full max-w-lg w-full z-40 [transition:all_200ms_ease-in-out,opacity_100ms_ease-in-out] lg:top-auto lg:bottom-[105px] lg:left-auto lg:right-[15px] lg:translate-x-0 lg:h-[600px] lg:max-w-md lg:p-0`}>
